...
class CyberTheme {
  ...
  static TextStyle headerText({double size = 18, Color? color}) {
    return TextStyle(
      fontFamily: fontFamily,
      fontSize: size,
      ...
      letterSpacing: 1.5,
      shadows: [
        Shadow(color: (color ?? neonCyan).withOpacity(0.5), blurRadius: 8),
        Shadow(color: (color ?? neonCyan).withOpacity(0.3), blurRadius: 16),
      ],
    );
  }
