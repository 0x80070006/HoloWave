...
Future<void> main() async {
  ...
  await JustAudioBackground.init(
    ...
    androidNotificationChannelName: 'HoloWave',
  ...
  runApp(const HoloWaveApp());
}

class HoloWaveApp extends StatelessWidget {
  const HoloWaveApp({super.key});
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text('HOLOWAVE', style: CyberTheme.headerText(size: 28)),
              const SizedBox(height: 4),
              Text('HOLOGRAPHIC AUDIO SYSTEM', style: CyberTheme.labelText(color: CyberTheme.textDim)),
