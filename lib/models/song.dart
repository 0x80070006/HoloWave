  ...
  factory Song.fromSongModel(SongModel model) {
    ...
    try {
      ...
      if (pathParts.length > 1) {
        ...
        folder = pathParts.isNotEmpty ? pathParts.last : 'Unknown';
      }
...
class Playlist {
  ...
  Playlist({required this.name, required this.songIds, DateTime? createdAt})
      : createdAt = createdAt ?? DateTime.now();

  Map<String, dynamic> toJson() => {
        'name': name, 'songIds': songIds, 'createdAt': createdAt.toIso8601String(),
      };
